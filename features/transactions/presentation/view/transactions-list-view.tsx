...
export const TransactionListView = () => {
  const { transactions, handleDelete, handleAdd, handleEdit } = useTransactionsView()
  return (
    <>
      <div className="flex h-screen w-full flex-col items-center justify-center">
        <div className="h-3/5 w-3/4">
          ...
          <TableBreadCrumb />
          <div className="mt-4">
            <TransactionsTable data={transactions} handleDelete={handleDelete} handleEdit={handleEdit} />
          </div>
        </div>
      </div>
    </>
